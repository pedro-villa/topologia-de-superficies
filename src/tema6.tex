...
\corp{%
\textbf{Corolario 3.8.2}
Sea $X = U \cup V$ con $U,\,V\subseteq X$ abiertos tales que $U$ y $V$ son conexos por caminos y simplemente conexos, y
$U\cap V \neq \varnothing$ con $U\cap V$ conexo por caminos.
Entonces $X$ es simplemente conexo.%
}{%
Sea $x_{0}\in U\cap V$.  Como $U$ y $V$ son conexos por caminos entonces $X = U\cup V$ es conexo por caminos, lo que nos permite
identificar $\pi_{1}(X)\cong\pi_{1}(X,x_{0})$.
\newline\noindent
Por el teorema de Seifert-van Kampen las inclusiones $i:U\hookrightarrow X$ y $j:V\hookrightarrow X$
inducen homomorfismos $i_{*}$ y $j_{*}$ cuyas imágenes generan
$\pi_{1}(X,x_{0})$.

\medskip\noindent
Como $U$ y $V$ son simplemente conexos,
$\pi_{1}(U,x_{0})=\pi_{1}(V,x_{0})=\{1\}$, de modo que
$\operatorname{Im}i_{*}=\operatorname{Im}j_{*}=\{1\}$.

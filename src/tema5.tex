...
\propp{Equivalencia por transformaciones elementales}{
    ...
    Si \(W_{1}\) tiene longitud \(4\) o más, podemos escribir \(W_{1}=Xbc\) para algún \(X\) de longitud al menos \(2\). Entonces cortamos a lo largo de \(a\) para obtener
    \[
    \langle S,b,c,e \mid Xbcee^{-1}\rangle\cong\langle S,a,b,c,e \mid Xa^{-1},abcee^{-1}\rangle
    \]
    y procedemos como antes.
}
